    ...
    initData: {
      ...
      store: [
...

        {
          ...
          from: "static",
          url: `${DATASETS_REPO_BASE}/reports/reports-maille-national.json`,
          backupUrl: `${DATASETS_FOLDER}/prod/reports/reports-maille-national.json`,
          displayed: true,
          copyTo: [
            {
        ...
        },
        {
          ...
          from: "static",
          url: `${DATASETS_REPO_BASE}/reports/reports-maille-regional.json`,
          backupUrl: `${DATASETS_FOLDER}/prod/reports/reports-maille-regional.json`,
          displayed: true,
        },
        {
          ...
          from: "static",
          url: `${DATASETS_REPO_BASE}/reports/reports-maille-departemental.json`,
          backupUrl: `${DATASETS_FOLDER}/prod/reports/reports-maille-departemental.json`,
          displayed: false,
        },
      ],
    },
